...
---| "BIOME_APPARITION_CHANCE" `int = 30` Used for Kummitus state transitions 0 -> 3
...
---| "CELLFACTORY_CELLDATA_MAX_COUNT" `int = 1024` The max number of individual materials permitted to exist by the engine
